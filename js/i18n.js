...
window.I18N = {
  en: {
    ...
    fx: { glitch: 'GLITCH', scanlines: 'SCANLINES', chromatic: 'RGB', slim: 'SLIM' },
    btn: {
      addMessage: '+ MESSAGE',
  ...
  ru: {
    ...
    fx: { glitch: 'ГЛИТЧ', scanlines: 'ПОЛОСЫ', chromatic: 'RGB', slim: 'УЗКИЙ' },
    btn: {
  ...
  es: {
    ...
    fx: { glitch: 'GLITCH', scanlines: 'LÍNEAS', chromatic: 'RGB', slim: 'SLIM' },
    btn: {
      addMessage: '+ MENSAJE',
  ...
  ja: {
    ...
    fx: { glitch: 'グリッチ', scanlines: 'スキャンライン', chromatic: 'RGB', slim: 'スリム' },
    btn: {
      addMessage: '+ メッセージ',
      addSysMessage: '+ システム',
      clearAll: '全クリア',
  ...
  zh: {
    ...
    fx: { glitch: '故障', scanlines: '扫描线', chromatic: 'RGB', slim: '窄屏' },
    btn: {
      addMessage: '+ 消息',
      addSysMessage: '+ 系统',
      clearAll: '全部清除',
